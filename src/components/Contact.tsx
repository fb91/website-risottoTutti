        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-bold rounded-full transition-colors mt-4"
            >
          ...
          {/* Horarios */}
          <div>
            <h3 className="font-bold text-xl mb-6">Horarios</h3>
            ...
            {/* Social */}
            {(content.socialInstagram || content.socialFacebook) && (
              <div className="mt-8">
                <h3 className="font-bold text-xl mb-4">Seguinos</h3>
                <div className="flex gap-4">
                  {content.socialInstagram && (
                    <a
                      href={`https://instagram.com/${content.socialInstagram.replace("@", "")}`}
                      target="_blank"
                      rel="noopener noreferrer"
