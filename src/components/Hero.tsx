    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-bold text-lg rounded-full transition-colors shadow-lg"
        >
